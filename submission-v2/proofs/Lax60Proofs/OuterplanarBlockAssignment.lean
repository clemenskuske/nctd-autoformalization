...
namespace Lax60Proofs.OuterplanarBlockAssignment
...
/--
---
conclusion: Lax60.OuterplanarBlockAssignment.exists_two_label_assignment
---
...
theorem exists_two_label_assignment
  ...
  exists_two_label_assignment_of_degree_two
    (fun H _ hHouter hHtwo =>
      Lax60ThetaFinal.exists_degree_two_outerplanar_twoConnected
        H hHouter hHtwo)
    G houter htwo

end Lax60Proofs.OuterplanarBlockAssignment
