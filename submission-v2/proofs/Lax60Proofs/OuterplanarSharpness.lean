...
namespace Lax60Proofs.OuterplanarSharpness

open Lax60.OuterplanarSharpness
...
lemma outer_closedBall_iff (v x : Fin 6) :
  ...
  rw [Lax60Proofs.PlanarSharpness.mem_closedBall_one_iff]
...
lemma outer_adj_iff (v w : Fin 6) :
  ...
  unfold outerAdj
  rw [← outer_closedBall_iff, Lax60Proofs.PlanarSharpness.mem_closedBall_one_iff]
  constructor
  · intro hadj
...
/--
---
conclusion: Lax60.OuterplanarSharpness.positiveNCTD_ge_two
---
...
end Lax60Proofs.OuterplanarSharpness
