...
namespace Lax16Proofs.OuterplanarLayer
...
/--
---
conclusion: Lax16.OuterplanarLayer.exists_outerplanar_layer_assignment
assumptions:
...
theorem exists_outerplanar_layer_assignment {V : Type u} [Fintype V]
  ...
  have hbound :
      positiveNCTD H 1 ≤ 2 :=
    Lax16.OuterplanarBound.positiveNCTD_le_two H houterH
...
end Lax16Proofs.OuterplanarLayer
